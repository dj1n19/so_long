...
{
	if (datas->map->map[datas->player->pos_y - 1][datas->player->pos_x]
			!= '1')
	{
...
{
	if (datas->map->map[datas->player->pos_y][datas->player->pos_x + 1]
			!= '1')
	{
...
int	ft_move(int keycode, t_datas *datas)
{
	if (keycode == NORTH)
		...
		move_west(datas);
	if (datas->map->map[datas->player->pos_y][datas->player->pos_x]
			== 'C')
	{
		datas->map->map[datas->player->pos_y][datas->player->pos_x] = '0';
		datas->collected--;
